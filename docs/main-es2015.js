...
const toLogin = () => Object(_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["redirectUnauthorizedTo"])(['/usuario/entrar']);
...
const routes = [
    ...
    },
    {
        ...
        path: 'usuario/entrar',
        loadChildren: () => __webpack_require__.e(/*! import() | usuario-entrar-entrar-module */ "usuario-entrar-entrar-module").then(__webpack_require__.bind(null, /*! ./usuario/entrar/entrar.module */ "./src/app/usuario/entrar/entrar.module.ts")).then(m => m.EntrarPageModule),
    ...
    },
    {
        ...
        path: 'usuario/sair',
        loadChildren: () => __webpack_require__.e(/*! import() | usuario-sair-sair-module */ "usuario-sair-sair-module").then(__webpack_require__.bind(null, /*! ./usuario/sair/sair.module */ "./src/app/usuario/sair/sair.module.ts")).then(m => m.SairPageModule),
        canActivate: [_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuthGuard"]],
    ...
    },
    {
        // Acessível somente para usuário logado
        path: 'usuario/perfil',
        loadChildren: () => __webpack_require__.e(/*! import() | usuario-perfil-perfil-module */ "usuario-perfil-perfil-module").then(__webpack_require__.bind(null, /*! ./usuario/perfil/perfil.module */ "./src/app/usuario/perfil/perfil.module.ts")).then(m => m.PerfilPageModule),
        canActivate: [_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuthGuard"]],
        data: { authGuardPipe: toLogin }
    },
    {
        // Acessível somente para usuário logado
        path: 'usuario/novo',
        loadChildren: () => Promise.all(/*! import() | usuario-novo-novo-module */[__webpack_require__.e("default~usuario-editar-editar-module~usuario-novo-novo-module"), __webpack_require__.e("usuario-novo-novo-module")]).then(__webpack_require__.bind(null, /*! ./usuario/novo/novo.module */ "./src/app/usuario/novo/novo.module.ts")).then(m => m.NovoPageModule),
        canActivate: [_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuthGuard"]],
        data: { authGuardPipe: toLogin }
    },
    {
        // Acessível somente para usuário logado
        path: 'usuario/editar',
        loadChildren: () => Promise.all(/*! import() | usuario-editar-editar-module */[__webpack_require__.e("default~usuario-editar-editar-module~usuario-novo-novo-module"), __webpack_require__.e("usuario-editar-editar-module")]).then(__webpack_require__.bind(null, /*! ./usuario/editar/editar.module */ "./src/app/usuario/editar/editar.module.ts")).then(m => m.EditarPageModule),
        canActivate: [_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuthGuard"]],
        data: { authGuardPipe: toLogin }
    }
];
...
module.exports = __webpack_require__(/*! J:\Projetos\Ionic\karasuno01\src\main.ts */"./src/main.ts");
